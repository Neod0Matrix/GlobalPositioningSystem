...
//模块声明
#define _Modules_Type_			"GPS"						//模块类型
#define _Modules_Name_			"GlobalPositioningSystem"	//模块名称
#define _Modules_Version_ 		"v0p1_LTE"					//长期演进版
...
#define ScreenPageCount			6u							//裁去ui.h中定义的总切屏数到这里来重新定义
